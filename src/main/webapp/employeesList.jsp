            ...
            <div class="modal-body">
                ...
                <form method="POST" action="/addEmployee">
                    ...
                    <div class="form-group">
                        <c:choose>
                            <c:when test="${not empty eName}">
                                <input class="form-control" align="center" type="text" name="EmpName" value="${eName}"
                    ...
                    <div class="form-group">
                            ...
                            <input class="form-control" type="date" name="EmpDob" value="2013-01-08"/>
                    </div>
                    <div class="form-group">

                    <c:choose>
                            <c:when test="${not empty eAddress}">
                                <input class="form-control" align="center" type="text" name="EmpAdd" value="${eAddress}"
                    ...
                    <c:choose>
                            <c:when test="${not empty eEmail}">
                                <input class="form-control" align="center" type="text" name="EmpEmail" value="${eEmail}"
