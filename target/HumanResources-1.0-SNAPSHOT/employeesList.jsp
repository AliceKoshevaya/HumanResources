...
<form method="POST" action="/addEmployee">
    ...
    <input class="form-control" type="text" name="EmpName" placeholder="Enter employee name"/>
    <input class="form-control" type="text" name="EmpLname" placeholder="Enter employee lastName"/>
    <input class="form-control" type="text" name="EmpTname" placeholder="Enter employee thirdName"/>
    <input class="form-control" type="text" name="EmpExp" placeholder="Enter employee experience"/>
    <input type="hidden" name="code" value="${idJob}"/>
    <select name="EmpSex">
        <option value="MAN">Man</option>
        <option value="WOMAN">Woman</option>
    </select>
    <input class="form-control" type="date" name="EmpDob" placeholder="Enter employee Date of Birthday"/>
    <input class="form-control" type="text" name="EmpAdd" placeholder="Enter employee address"/>
    <input class="form-control" type="text" name="EmpTel" placeholder="Enter employee telephone"/>
    <input class="form-control" type="email" name="EmpEmail" placeholder="Enter employee email"/>
    <select name="jobCode">
